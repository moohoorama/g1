...
import com.elcarim.myapplication.graphic.layer.UI.UIObj
 ...
 */
class UILayer(activity: MainActivity, private val blinkSize:Int, private val fontSize:Int): Layer(activity,128  ) {
